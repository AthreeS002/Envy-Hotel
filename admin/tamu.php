                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      $id = $_GET['id'];
                      $tamu = mysqli_query($koneksi, "SELECT * FROM registrasi");
                      ...
                      while ($row = mysqli_fetch_array($tamu)) {
                        echo "
                          <tr>
                            ...
                            ";
                                ?>
                                  <a href="edit_tamu.php?nin=<?= $row['nin']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Mengubah Data?')"><i class=' btn btn-warning py-0 px-1 far fa-edit'></i></a>
                                  &nbsp;
                                  <a href="hapus_tamu.php?nin=<?= $row['nin']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')"><i class=' btn btn-danger py-0 px-1 far fa-trash-alt'></i></a>
                                <?php
                                  echo "
                            </td>
                          </tr>
