...
$query = mysqli_query($koneksi, "SELECT * FROM transaksi where id_transaksi");
while ($item = mysqli_fetch_array($query)){
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Reservation</h2>
						<p>In this page, you can book, checkin, checkout or cancel your request. <br> But maybe it need acception from admin first.</p>
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="inner-column text-center">
									...
									<a class="btn btn-lg btn-circle btn-primary" href="checkin_req.php?id=<?=$id;?>&nin=<?=$item['nin'];?>">Check In</a>
									<a class="btn btn-lg btn-circle btn-danger" href="cancel_req.php?id=<?=$id;?>&nin=<?=$item['nin'];?>">Cancel</a>
								</div>
							</div>
						</div>
			<?php
