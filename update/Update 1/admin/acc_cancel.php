...
include '../koneksi.php';
    ...
    $result = mysqli_query($koneksi, "UPDATE registrasi SET status='Unbooked Yet' WHERE nin = $nin");
    $result2 = mysqli_query($koneksi, "UPDATE transaksi SET status='Cancelled' WHERE id_transaksi = $id");
